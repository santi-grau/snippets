...
class Geo extends Group{
    constructor( res ){
        ...
        // geometry.setAttribute( 'ids', new BufferAttribute( new Float32Array( ids ), 3 ) )
        ...
        // var materialWire = new MeshBasicMaterial( { wireframe : true, color : 0xdddddd } )
        // var wireMesh = new Mesh( geometryFull, materialWire )
        // wireMesh.position.z = 3
        // this.add( wireMesh )
