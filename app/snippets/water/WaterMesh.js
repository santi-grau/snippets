...
import smoothFragmentShader from './smooth.frag'
import readWaterLevelFragmentShader from './readWaterLevel.frag'
import { GPUComputationRenderer } from 'three/examples/jsm/misc/GPUComputationRenderer.js';
import { Mesh, PlaneBufferGeometry, ShaderMaterial, UniformsUtils, ShaderLib, Vector2, WebGLRenderTarget, ClampToEdgeWrapping, NearestFilter, RGBAFormat, UnsignedByteType } from 'three';
...
class WaterMesh extends Mesh{
    constructor( WIDTH, BOUNDS, renderer ){
        ...
        this.gpuCompute.createShaderMaterial( smoothFragmentShader, { smoothTexture: { value: null } } )
